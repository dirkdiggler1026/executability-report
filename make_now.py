...
<head>
<meta charset="utf-8">
<meta name="description" content="The live view: the newest published round on Robinhood Chain, the block it was pinned at, and what comes back when you sell each tokenised stock.">
<title>what comes back when you sell &mdash; live</title>
<link rel="icon" href="favicon.ico" sizes="any">
<link rel="icon" type="image/png" sizes="32x32" href="favicon-32.png">
<link rel="apple-touch-icon" href="apple-touch-icon.png">
<meta property="og:type" content="website">
<meta property="og:site_name" content="Executability Report">
<meta property="og:title" content="What comes back when you sell &mdash; live">
<meta property="og:description" content="Live view of the newest published round: the block it was pinned at, the round hash, and what comes back when you sell each token.">
<meta property="og:image" content="https://dirkdiggler1026.github.io/executability-report/og-image.png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:image:alt" content="A descending staircase mark on a dark background: the shape this project measures.">
<meta property="og:url" content="https://dirkdiggler1026.github.io/executability-report/now.html">
<meta property="og:locale" content="en">
<meta name="twitter:card" content="summary_large_image">
<!--
  The head tags above are duplicated in index.html and index.zh.html, which are hand-authored.
  A generator that does not carry them will silently delete them the next time it runs -- which
  is exactly what happened on 2026-09-26, when the tags were added to now.html by hand and this
  template still lacked them. code/check_heads.py asserts all three pages carry the set, so the
  next drift is caught by a check instead of by a reader.
-->
<!--
